            ...
            <div class="inner-content">
                ...
                <div class="d-grid grid-md-2 d-grid-no-space section-margin">
                    ...
                    <div class="pro-text background-section box-padding">
                        <div class="border-section-bottom mb-50">
                            <span class="tag-heading p-10 mb-15 background-main heading-color">Training & Placement Program</span>
                            <h2 class="heading-h2">Training in Fundamental Technologies</h2>
                        </div>
                        <p class="mb-10"><strong>We offer comprehensive training programs in the latest technologies to help you excel in the tech industry. Our curriculum is designed to provide you with hands-on experience and the skills required to succeed.</strong></p>
                        <p>Our training covers HTML, CSS, JavaScript, React JS, PHP, SQL, Node.js, Express, and database technologies. Our expert trainers will guide you through each technology, ensuring you gain a deep understanding and practical knowledge.</p>
                    </div>
                </div>
                ...
                <section class="services dsn-container p-relative section-margin" data-dsn-title="Our Service">
                    <div class="section-title">
                        ...
                        <h2 class="heading-h2">Delivering Comprehensive Training & Placement Solutions</h2>
                    </div>
                    <div class="d-grid grid-md-2 grid-lg-3 dsn-isotope grid ag-format-container" data-dsn-item=".service-item">
                        <div class="service-item ag-courses_box">
                            <div class="service-item-inner background-section style-box">
                                ...
                                <div class="content-box ag-courses-item_link">
                                    <h4 class="title-block mt-20">Technologies Covered</h4>
                                    <li class="mt-20">HTML, CSS, JavaScript, React JS</li>
                                    <li>PHP, SQL, Node.js, Express</li>
                            ...
                            <div class="service-item-inner background-section style-box">
                                ...
                                <div class="content-box">
                                    ...
                                    <p class="description mt-20">
                                        <li>Hands-on Training: Practical sessions to build real-world projects.</li>
                                        <li>Expert Trainers: Learn from industry experts.</li>
                                        <li>Placement Assistance: Get support in finding job opportunities.</li>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="service-item">
                            <div class="service-item-inner background-section style-box">
                                ...
                                <div class="content-box">
                                    <h4 class="title-block mt-20">Testimonials and Success Stories</h4>
                                    <p class="description mt-20">
                                        <li>Client Success Stories: Hear from our successful trainees.</li>
                                        <li>Before and After: Transform your career with our training.</li>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="service-item">
                            <div class="service-item-inner background-section style-box">
                                ...
                                <div class="content-box">
                                    ...
                                    <p class="description mt-20">
                                        <li>Flexible Pricing: Various plans for different needs.</li>
                                        <li>Subscription Models: Monthly, quarterly, and annual options.</li>
                                    </p>
                                </div>
                            </div>
                        </div>
