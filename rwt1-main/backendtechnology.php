...
<head>
    ...
    <!--  Title -->
    <title>Royals Webtech | Backend Technology</title>
        ...
        <div class="p-fixed has-parallax-header has-parallax-header v-dark-head background-main">
            <div class="p-absolute z-index-0 before-z-index h-100 w-100 " data-overlay="5" data-dsn-ajax="img">
                <img class="cover-bg-img"
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-dsn-src="assets/img/services/backend.jpg"
                    data-dsn-srcset="assets/img/services/backend.jpg 1800w,assets/img/project/project2/1-sm.jpg 768w"
                    alt="">
            </div>
        </div>
                    ...
                    <div class="d-grid grid-md-2 d-grid-no-space section-margin">
                        ...
                        <div class="inner-img h-100 " data-dsn-grid="move-up">
                            <img class="has-bigger-scale"
                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                data-dsn-src="assets/img/services/backend-developement.jpg"
                                data-dsn-srcset="assets/img/services/backend-developement.jpg 768w"
                                alt="" />
                        </div>
                        ...
                        <div class="d-grid grid-md-2 grid-lg-3 dsn-isotope grid" data-dsn-item=".service-item">
                            <div class="service-item">
                                <div class="service-item-inner background-section style-box">
                                    ...
                                    <div class="content-box">
                                        <h4 class="title-block mt-20">Node.JS Development</h4>
                                        <p class="description mt-20">WNodeJS is iconic for building backends of apps that are real-time,repuires heavy traffic or data,and code compatibility on many platforms.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="service-item">
                                <div class="service-item-inner background-section style-box">
                                    ...
                                    <div class="content-box">
                                        <h4 class="title-block mt-20">PHP Development</h4>
                                        <p class="description mt-20">We build enterprice solution,networking systems,CMS , and other backend solution that are highly customized for complex B2B application.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="service-item">
                                <div class="service-item-inner background-section style-box">
                                    ...
                                    <div class="content-box">
                                        <h4 class="title-block mt-20">.NET Development</h4>
                                        <p class="description mt-20">Royals Webtech builds custom web , mobile and windows based app solution with .NET framework to deliver scalability and power -packed performance.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="service-item">
                                <div class="service-item-inner background-section style-box">
                                    ...
                                    <div class="content-box">
                                        <h4 class="title-block mt-20">Java Development</h4>
                                        <p class="description mt-20">We have hands -on experience with java based framework like spring,Hibernate,JSF,GWT,etc.To build scalable and secure business apps.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="service-item">
                                <div class="service-item-inner background-section style-box">
                                    ...
                                    <div class="content-box">
                                        <h4 class="title-block mt-20">Python Development</h4>
                                        <p class="description mt-20">We use python with Django, Flask, Pyramid, and other framework to build automation solution, AI-ML apps , GUI apps for mobile and web , etc.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="service-item">
                                <div class="service-item-inner background-section style-box">
                                    ...
                                    <div class="content-box">
                                        <h4 class="title-block mt-20">Ruby on Rails Development</h4>
                                        <p class="description mt-20">With this MVC framework launched in 2004, we are pioneering RoR development multi- tasking scalable.
                                        </p>
                                    </div>
                                </div>
                            </div>
